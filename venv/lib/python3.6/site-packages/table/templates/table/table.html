...
$(document).ready(function() {
    ...
    var table = $('#{{ table.opts.id }}').dataTable({
        ...
        "initComplete": function(oSettings, json) {
            ...
            $("#{{ table.opts.id }}_wrapper .dataTables_filter input").before('<span class="input-group-addon filter_icon" style="background:transparent;border:none;"><i class="glyphicon glyphicon-search"></i></span>');
